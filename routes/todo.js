...
router.get(
  ...
  authentication,
  TodoController.findIncompleteTodos
);
router.get(
  "/api/todos/complete",
  authentication,
  TodoController.findCompleteTodos
);
router.get(
  "/api/todos/important",
  authentication,
  TodoController.findImportantTodos
);
...
router.post(
  "/api/todos/:todoId/category",
  authentication,
  TodoController.addCategory
);
router.delete(
  "/api/todos/:todoId/category/:categoryId",
  authentication,
  TodoController.removeCategory
);
